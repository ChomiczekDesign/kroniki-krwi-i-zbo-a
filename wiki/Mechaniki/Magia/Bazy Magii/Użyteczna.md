# Magia Użyteczna (Utility)

Zaklęcia tego typu są najprostszym sposobem, w jaki czarujący narzuca swoją wolę światu: porusza drobne przedmioty bez dotyku, przywołuje światło, wyczuwa obecność magii albo zostawia w rzeczach ślad własnej myśli, emocji lub intencji.

Nie są to zaklęcia niebezpieczne ani potężne. Ich siła nie polega na niszczeniu, leczeniu czy ochronie, lecz na subtelnym naginaniu rzeczywistości do zamiaru czarującego. Magia Użyteczna pozwala postaci pokazać, że jej wola może odcisnąć się na świecie nawet w drobnych, codziennych sprawach.

## Podstawowy Efekt
**[[Koncentracja]]:** Nie
- Podczas [[Budowanie zaklęć|budowania zaklęcia]] czarujący wybiera 1 **Efekt Użyteczny** z listy poniżej lub uzgodniony z MG. Wybrany efekt określa, co dokładnie potrafi dane zaklęcie.
	- Czarujący wykonuje test odpowiedniej umiejętności magicznej. Bazowa trudność testu wynosi **Easy** (#Difficulty).
	- Jeśli test zakończy się sukcesem, czarujący wywołuje wybrany efekt.
- Utility nie może zadawać obrażeń ani kopiować efektów innych zaklęć.
...
- **Increase Encumbrance** (**+ #Difficulty**)  
  Zwiększ maksymalny **[[Encumbrance]]** przedmiotu o 1. Opcję tę można wybrać wielokrotnie.
- **Additional Target** (**+ #Difficulty**)  
  Zaklęcie oddziałuje na 1 dodatkowy cel znajdujący się w zasięgu zaklęcia. Dodatkowo możesz wydać #Advantage, aby objąć zaklęciem 1 dodatkowy cel za każde wydane #Advantage.
## Przykładowe Efekty Użyteczne
Podczas [[Budowanie zaklęć|budowania zaklęcia]] czarujący wybiera 1 **Efekt Użyteczny** z poniższej listy lub ustalony z MG. Wybrany efekt określa podstawowe działanie zaklęcia.

Jeśli efekt posiada czas trwania, trwa 5 minut poza ustrukturyzowanym starciem albo do końca następnej tury czarującego w ustrukturyzowanym starciu.
...
### Odczyt Materii
**[[Koncentracja]]:** Tak  
- Zaklęcie pozwala czarującemu poznać prostą, niemagiczną właściwość dotkniętego albo trzymanego przedmiotu.
- Może ujawnić przybliżoną masę, temperaturę, długość, rodzaj materiału, podstawowy skład, wiek przedmiotu, ślady zużycia albo inną oczywistą fizyczną cechę.
- Może również wyostrzyć zmysł dotyku czarującego, pozwalając wyczuwać drobne nierówności, fakturę, pęknięcia, drgania albo wypukłe znaki.
...
**[[Koncentracja]]:** Tak  
- **Minimalna Ranga Magii:** 3  
- Wzmocniony efekt pozwala podpalić 1 przedmiot, powierzchnię albo miejsce lub ugasić silniejsze lub bardziej niebezpieczne źródło ognia w zasięgu **[[Zasięgi|Short]]**, takie jak duży pożar, płonąca istota, rozżarzona broń, magiczny ogień albo efekt zaklęcia bojowego.  
- Zaklęcie może również kontrolować temperaturę istniejącego płomienia, żaru albo innego źródła ciepła, o ile ma ono wystarczające paliwo lub warunki, aby utrzymać wskazany poziom ciepła.  
- Powstały płomień nie jest kontrolowany przez czarującego i rozprzestrzenia się albo gaśnie zgodnie z warunkami sceny oraz decyzją MG.  
	- Jeśli cel jest niepalny albo nie zapewnia warunków do utrzymania ognia, płomień pozostaje tylko tak długo, jak czarujący utrzymuje [[Koncentracja|Koncentrację]].  
	- Jeśli ogień jest częścią aktywnego zaklęcia, efekt działa jak próba przeciwstawienia się temu zaklęciu, a ostateczne rozstrzygnięcie należy do MG.  
	- Jeśli ogień jest podtrzymywany przez [[Koncentracja|Koncentrację]] innego czarującego, upgrade’uj trudność testu raz za każdą rangę jego **Discipline**.  
...
- Przedmiot może zostać powoli uniesiony, przesunięty, przyciągnięty, odepchnięty, obrócony albo podtrzymany w miejscu.
- Zamiast poruszać przedmiotem swobodnie, czarujący może wymusić na nim 1 prostą czynność, taką jak otwarcie niezaryglowanych drzwiczek, przesunięcie zasłony, obrócenie kartki, pociągnięcie za sznurek, zamknięcie szkatułki albo strącenie lekkiego, niestabilnego obiektu.
...
- Zaklęcie pozwala utrzymywać pełną manipulację 1 przedmiotem w zasięgu **[[Zasięgi|Short]]**, tak jakby czarujący trzymał go i używał na odległość.
- Przedmiot pozostaje pod wpływem zaklęcia tak długo, jak czarujący utrzymuje [[Koncentracja|Koncentrację]].
	- Czarujący może wydać swój manewr, aby nakazać przedmiotowi wykonanie prostego ruchu, zmianę pozycji, przemieszczenie się, podanie czegoś, użycie narzędzia albo wykonanie innej czynności, która normalnie wymagałaby manewru.
	- Czarujący może wydać swoją akcję, aby przedmiot wykonał czynność wymagającą akcji, w tym atak bronią, rzut przedmiotem, użycie narzędzia albo inny test umiejętności, jeśli dany przedmiot pozwala wykonać taką czynność.
- Korzystanie z przedmiotu na odległość używa normalnych umiejętności, charakterystyk, profilu broni, ograniczeń i zasad powiązanych z tym przedmiotem. Zaklęcie pozwala jedynie używać go bez bezpośredniego trzymania.
...
- Lewitowany cel musi znajdować się w zasięgu zaklęcia. Bazowy zasięg wyboru celu to **[[Zasięgi|Short]]**.
- Lewitowany cel może zostać uniesiony maksymalnie na wysokość równą aktualnemu zasięgowi zaklęcia względem ziemi albo najbliższej stabilnej powierzchni pod nim.
    - Przy bazowym zasięgu **Short** cel może więc lewitować najwyżej na wysokości **Short**.
    - Każde zwiększenie zasięgu zaklęcia zwiększa również maksymalną wysokość lewitacji.
...
- Zaklęcie pozwala rzucać przedmiotami, aby ranić przeciwników. Czarujący wybiera 1 przedmiot znajdujący się w zasięgu zaklęcia, po czym wykonuje nim atak dystansowy przeciwko celowi w maksymalnym zasięgu zaklęcia. Bazowy zasięg to Short
	- Atak traktowany jest jako **atak dystansowy magiczny**. 
...
### Temperatura
**[[Koncentracja]]:** Tak  
- Zaklęcie ogrzewa, schładza albo utrzymuje temperaturę nieożywionej materii o **[[Encumbrance]] 0** w zasięgu **[[Zasięgi|Short]]**.
- Efekt może podgrzać posiłek, schłodzić napój, ogrzać kamień, ochłodzić metalowy kubek albo utrzymać niewielki przedmiot lub porcję materii w pożądanej temperaturze.
- Zaklęcie może również kontrolować temperaturę istniejącego płomienia, żaru albo innego źródła ciepła, o ile ma ono wystarczające paliwo lub warunki, aby utrzymać wskazany poziom ciepła.
...
### Wilgoć
**[[Koncentracja]]:** Nie  
- Zaklęcie osusza albo zwilża 1 niewielki nieożywiony przedmiot, ubranie, księgę, porcję materiału o **[[Encumbrance]] 0** albo małą powierzchnię w zasięgu **[[Zasięgi|Short]]**.
- Może usunąć wodę, wilgoć, rosę, zwykły deszcz albo rozlany płyn o neutralnym działaniu.
- Może również lekko zwilżyć, zrosić albo namoczyć powierzchnię, materiału, zbierając wilgoć z powietrza lub najbliższego otoczenia.
...
- Bazowo zaklęcie tworzy ilość wody wystarczającą do napełnienia kubka, miski, bukłaka albo małego kociołka.
	- Za każde nieanulowane #Success ponad pierwszy, czarujący może zwiększyć ilość stworzonej wody o podobną porcję lub nadać wodzie większe ciśnienie, zgodnie z decyzją MG .
	- Woda stworzona tym efektem jest zwykłą wodą. 
...
- Traktuj ten efekt jak test odpowiedniej umiejętności **Knowledge** wykonany w ramach rzucania zaklęcia. Nieanulowane #Success oraz #Advantage mogą zostać wydane, aby uzyskać więcej informacji albo poznać bardziej szczegółowe odpowiedzi, zgodnie z decyzją MG.
